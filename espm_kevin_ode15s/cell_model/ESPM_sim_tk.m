function [V_cell, T_core, T_surf,soc_bulk_n, soc_bulk_p, cs_n, cs_p,...
          ...
          c_sei,c_li,i_lpl,L_film,af_n,af_p,param, te, xe, ie] = ESPM_sim_tk(x,dt,t_data,I_data,SOC_IC,Q_IC,Lsei_IC,T_amb) 
    ...
    [V_cell, T_core, T_surf,soc_bulk_n, soc_bulk_p, cs_n, cs_p,...
        ce_all, L_sei,i_s,Q,V_oc,R_el,R_sei,Csolv,aina_n,aina_p,c_sei,c_li,i_lpl,L_film,af_n,af_p,param, te, xe, ie] = Module_Run(x_initial,param);
