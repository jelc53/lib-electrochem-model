...
param.Dsn_ref = 10^(-x(11));   % Anode diffusion coefficient
param.Dsp_ref = 10^(-x(12));   % Cathode diffusion coefficient

% Reaction rates
param.kn_ref = 10^(-x(13))/param.F;     % Anode reaction rate constant 
param.kp_ref = 10^(-x(14))/param.F;     % Cathode reaction rate constant
