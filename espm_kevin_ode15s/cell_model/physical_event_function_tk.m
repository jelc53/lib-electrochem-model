...
value6 = seconds(TIMENEW-param.TIMEOLD) < 5;
%
...
% value = [value2; value3; value5; value6];  % when value = 0, an event is triggered
% isterminal = [1; 1; 1; 1]; % terminate after the first event
% direction = [0; 0; 0; 0]; % get all the zeros


value = [value2; value3; value5];  % when value = 0, an event is triggered
isterminal = [1; 1; 1]; % terminate after the first event
direction = [0; 0; 0]; % get all the zeros
