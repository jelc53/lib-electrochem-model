...
value1 = min(x(1:param.Nc*(param.Nr-1))) - (0.001*param.c_n_max); %Cs_n < 10, end integration
value2 = max(x(1:param.Nc*(param.Nr-1))) - (param.c_n_max)*0.999;
value3 = min(x(param.Nc*(param.Nr-1)+1:2*param.Nc*(param.Nr-1))) - (0.001*param.c_p_max);
value4 = max(x(param.Nc*(param.Nr-1)+1:2*param.Nc*(param.Nr-1))) - (param.c_p_max)*0.999; 
value5 = isreal(x);
