...
eta_p = eta_cathode(theta_surf_p, ce_p_avg, T_core, input_crt, param, kp);
eta_n = eta_anode(theta_surf_n, ce_n_avg, T_core, input_crt, param, kn);
...
dcsn_dt = A_csn*cs_n + param.B_sd_n.*input_crt/(param.a_sn);
dcsp_dt = A_csp*cs_p + param.B_sd_p*input_crt/(param.a_sp);
